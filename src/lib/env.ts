...
const envSchema = z.object({
  ...
  CRYPTOMUS_API_URL: z.string().url().default("https://api.cryptomus.com/v1"),
  CRYPTOMUS_MERCHANT_UUID: optionalString,
  CRYPTOMUS_PAYMENT_API_KEY: optionalString,
  CRYPTOMUS_TRC20_NETWORK: z.string().min(1).default("tron"),
  CRYPTOMUS_ERC20_NETWORK: z.string().min(1).default("eth"),
  CRYPTOMUS_BEP20_NETWORK: z.string().min(1).default("bsc"),
